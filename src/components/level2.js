...
const Level2 = () => {
    ...
    const generateQuestion = () => {
        ...
        const num2 = Math.floor(Math.random() * num1); // Ensures num2 is less than num1
    ...
    const handleSubmit = () => {
        ...
        if (parseInt(answer) === correctAnswer) {
            ...
            if (correctAnswers + 1 === 5) {
                ...
                // Display reward and navigate to the next level after a short delay
            ...
            const newIncorrectAnswers = [...incorrectAnswers, { question: `${question.num1} - ${question.num2}`, userAnswer: answer, correctAnswer }];
    ...
    return (
        <div className="level-container">
            <h2>Level 2: Subtraction</h2>
            {!gameOver && correctAnswers < 5 && incorrectAnswers.length < 3 ? (
                <>
                ...
                <div className="reward-message">
                    ...
                    {correctAnswers === 5 && totalQuestionCount <= 5 ? (
                        <p>You've answered all questions correctly!</p>
                    ) : (
                        <p>You have got {correctAnswers}/5 in {totalQuestionCount} questions.</p>
                    )}
